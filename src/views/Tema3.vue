  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.align-items-start.mb-5.position-relative
      .col-lg-8.pe-lg-4.order-2.order-lg-1
        p Las empresas proyectan la duración de los presupuestos, de acuerdo a la necesidad que tengan de control, seguimiento y ejecución; las fechas de corte se pueden realizar de la siguiente manera:
    ...
    .bloque-texto-g.bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema3/img-4.jpg')})`}"
      )
    ...
    p.mb-5 De acuerdo con la siguiente figura 10, una estructura del presupuesto maestro y el orden respectivo en que se realiza cada uno.
    ...
    p.mb-5 Los presupuestos son considerados una herramienta interna de planeación y proyección financiera a largo plazo.
